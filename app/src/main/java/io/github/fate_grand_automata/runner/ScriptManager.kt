...
class ScriptManager @Inject constructor(
    ...
    /**
     * The OCR engine belonging to the current [ScriptComponent]. Held so its native resources
     * can be freed as soon as the run ends instead of waiting on the finalizer.
     */
